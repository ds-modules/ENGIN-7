...
my_sin_approx, my_collision, my_projectile, my_projection, my_array_metrics_num, my_array_metrics_lgcl, my_polygon_perimeter = None, None, None, None, None, None, None
...
class TestQ2(unittest.TestCase):
    def test_q2(self):
        ...
        assertTuple(self, my_collision(1, 3, 35, 50), ans1)
        assertTuple(self, my_collision(1, 5, 45, 30), ans2)
        assertTuple(self, my_collision(5, 10, 15, 5), ans3)
...
class TestQ3(unittest.TestCase):
    def test_q3(self):
        ...
        ans5 = (1.307336141214872, 14.942920471376183, 0, -9.81, 9.81, 1.307336141214872, -14.487079528623816,
                ...
                11.38077840029936)
        assertTuple(self, my_projectile(10, 53, 1.4), ans1)
        assertTuple(self, my_projectile(10, 53, 1), ans2)
        assertTuple(self, my_projectile(20, 35, 1), ans3)
        assertTuple(self, my_projectile(17, 45, 2), ans4)
        assertTuple(self, my_projectile(15, 85, 3), ans5)
...
class TestQ4(unittest.TestCase):
    def test_q4(self):
        ...
        np.testing.assert_array_almost_equal(my_projection(np.array([0, 1]), np.array([2, 4])), ans1)
        np.testing.assert_array_almost_equal(my_projection(np.array([2, 0]), np.array([0, 1])), ans2)
        np.testing.assert_array_almost_equal(my_projection(np.array([2, 3]), np.array([7, 5])), ans3)
        np.testing.assert_array_almost_equal(my_projection(np.array([2, 3, 4, 9]), np.array([7, 5, 0, 1])), ans4)
...
class TestQ5(unittest.TestCase):
    def test_q51(self):
        ans1 = (3, 1, 2, 0)
        ans2 = (2, 2, 1, 2)
        assertTuple(self, my_array_metrics_num(np.array([[5, 0, 0], [1, -1, 7]])), ans1)
        assertTuple(self, my_array_metrics_num(np.array([[float('-inf'), 5, -1], [0, np.nan, 3]])), ans2)
    ...
    def test_q52(self):
        ...
        assertTuple(self, my_array_metrics_lgcl(np.array([10])), ans1)
        assertTuple(self, my_array_metrics_lgcl(np.array([[5, 0, 0], [1, -1, 7]])), ans2)
        assertTuple(self, my_array_metrics_lgcl(np.array([[float('-inf'), 5, -1], [0, np.nan, 3]])), ans3)
...
class TestQ6(unittest.TestCase):
    def test_q6(self):
        ...
        self.assertAlmostEqual(my_polygon_perimeter(np.array([0, 0, 2, 2]), np.array([0, 2, 2, 0])), ans1)
        self.assertAlmostEqual(my_polygon_perimeter(np.array([1, 4, 7]), np.array([1, 5, 1])), ans2)
        self.assertAlmostEqual(my_polygon_perimeter(np.array([3, 2, 4, 6, 7, 5]), np.array([1, 10, 6, 5, 2, 1])), ans3)
...
def run_q51(f5):
    global my_array_metrics_num
    my_array_metrics_num = f5
...
def run_q52(f5):
    global my_array_metrics_lgcl
    my_array_metrics_lgcl = f5
    q5 = unittest.TestSuite()
...
def run_q6(f6):
    global my_polygon_perimeter
    my_polygon_perimeter = f6
